package imperialist_competitive_algorithm;
...
public class ICA {
	...
	public ICA(int queens, int popSize, double rate, int noOfEmpires,
	...
	public void run() {
		...
		FileWriter fw = null;
		String FILENAME = "Outputs/ICAOutput";
		int t = 1;
		try {
